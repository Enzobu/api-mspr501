...
@region_controller.route('/region/<int:item_id>', methods=['GET'])
...
@region_controller.route('/region/<int:item_id>', methods=['PUT'])
...
@region_controller.route('/region/<int:item_id>', methods=['DELETE'])
